...
class GapSelection:
    ...
    def __init__(self):
        ...
        os.environ['STANFORD_PARSER'] ='/media/bhavin/New Volume1/mtech/hackathon/Automatic_Question_Generation-master/stanford-models'
        os.environ['STANFORD_MODELS'] = '/media/bhavin/New Volume1/mtech/hackathon/Automatic_Question_Generation-master/stanford-models'
        os.environ['CLASSPATH'] = '/media/bhavin/New Volume1/mtech/hackathon/Automatic_Question_Generation-master/stanford-models/stanford-parser-3.9.1-models.jar'
	    #print os.environ
        self.model_path ='/media/bhavin/New Volume1/mtech/hackathon/Automatic_Question_Generation-master/stanford-models/' + 'englishPCFG.ser.gz'
    ...
    def _extract_gaps(self, sentence, tree):
        ...
        candidates = []
        candidate = {}
        #entities = ['NP', 'NOUN', 'NUM', 'PROPN']
        entities = ['CD',  'JJ', 'NN', 'NP', 'PROPN']
